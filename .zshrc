...
PS1='%{$user_color%}%n%{$reset_color%}%{$bold%}@%{$reset_color%}%{$host_color%}%m:%{$dir_color%}%2~%{$reset_color%}%{$bold%}$(print-git-branch)%{$reset_color%}:%{$ABDUCO_SESSION%}%{$bold_color%}\$%{$reset_color%} '
